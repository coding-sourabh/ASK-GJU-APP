    ...
    <div className="widget__contents">
      <div className="widget__content">
        ...
        <div className="widget__contentTitle">
          <h5>Android Programming Classes</h5>
          <p>
            CSE department organizes Android development classes for students.
          </p>
        </div>
      </div>
      <div className="widget__content">
        ...
        />
        <div className="widget__contentTitle">
          <h5>VC Praises TNP Cell</h5>
          <p>VC praises TNP Cell's efforts in getting companies on campus.</p>
        </div>
      </div>
      <div className="widget__content">
        <img
        ...
        <div className="widget__contentTitle">
          <h5>New Art Club</h5>
          <p>New art club is here for students with a zeal for drawing.</p>
        </div>
      </div>
      <div className="widget__content">
        <img
        ...
        <div className="widget__contentTitle">
          <h5>History</h5>
          <p>These are some of the most influencial people of our past.</p>
        </div>
      </div>
      <div className="widget__content">
        <img
        ...
        <div className="widget__contentTitle">
          ...
          <p>Here are some tips to manage your finance in the hostel life.</p>
        </div>
      </div>
      <div className="widget__content">
        <img
        ...
        <div className="widget__contentTitle">
          <h5>Covid 19</h5>
          <p>We are winning. Follow all the covid protocols.</p>
        </div>
      </div>
    </div>
  );
